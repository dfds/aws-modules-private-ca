...
| <a name="provider_aws.crl"></a> [aws.crl](#provider\_aws.crl) | >= 4.50.0 |
...
| <a name="module_cloudfront_logs_bucket"></a> [cloudfront\_logs\_bucket](#module\_cloudfront\_logs\_bucket) | git::https://github.com/dfds/aws-modules-s3.git | v1.3.0 |
| <a name="module_crl_bucket"></a> [crl\_bucket](#module\_crl\_bucket) | git::https://github.com/dfds/aws-modules-s3.git | v1.3.0 |
| <a name="module_s3_logs_bucket"></a> [s3\_logs\_bucket](#module\_s3\_logs\_bucket) | git::https://github.com/dfds/aws-modules-s3.git//s3-logging-bucket | v1.3.0 |
...
| [aws_caller_identity.crl_account](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/caller_identity) | data source |
| [aws_caller_identity.pca_account](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/caller_identity) | data source |
...
| <a name="input_s3_logs_bucket"></a> [s3\_logs\_bucket](#input\_s3\_logs\_bucket) | S3 bucket name to store S3 logs | `string` | n/a | yes |
